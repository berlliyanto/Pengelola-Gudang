...
<link rel ="icon"
                type="image/png"
                href="image/RRM.png"/>
  <title>Export Data Barang Masuk (admin)</title>
...
<div class="container">
			...
			<h4>(Inventory)</h4>
                ...
                <div class="sb-nav-link-icon"><h4><a href="masuk.php"><i class="fas fa-arrow-left">Kembali</i></a></h4></div>
                <form method="post">
                                <table>
                                    <tr>
                                        <td> Dari Tanggal </td>
                                        ...
                                        <td>
                                                ...
                                                ?><?php }?></td>
                                        <td><a class="nav-link" href="exportmasuk.php">
                                            Reset Filter
                                            </a></td>
                                    </tr>
                                </table>
